        ...
        <div className="w-full sm:w-1/2 p-6 sm:p-8">
          <div className="rounded-lg h-full">
            <h2 className="text-3xl text-center md:text-wrap md:text-5xl font-bold my-4">
              Kutumbh: Comprehensive Disaster Management Solution
            </h2>
          </div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="w-full sm:w-1/2 p-6 sm:p-8 h-full">
          <div className="rounded-lg py-8 h-full">
            ...
            <p className="text-lg">
              The Kutumbh provides a digital meeting place where community members
        ...
        <div className="w-full sm:w-1/2 p-6 sm:p-8 h-full">
          <div className="rounded-lg py-8 h-full">
            ...
            <p className="text-lg mb-4">
              The Kutumbh provides a comprehensive resource management system that
